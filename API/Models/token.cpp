...
access_token(""),
refresh_token(""),
expires_at(std::chrono::time_point<std::chrono::steady_clock>::min()),
created_at(std::chrono::time_point<std::chrono::steady_clock>::min()),
updated_at(std::chrono::time_point<std::chrono::steady_clock>::min()){}
